...
//      TESTING AREA
        ...
        db.companies.find({ $or: [ { overview: {"$regex": 'wiki', "$options": "i"} }, { tag_list: {"$regex": 'wiki', "$options": "i"} } ] })
        ...
        */
        ...
        query['$or'] = 
        [ { overview: {"$regex": options.overview, "$options": "i"} }, { tag_list: {"$regex": options.overview, "$options": "i"} } ];
    }
